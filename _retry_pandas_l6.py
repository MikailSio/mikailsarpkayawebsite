"""Retry pandas/L6 screenshot with longer timeout."""
import sys
...
url = "http://localhost:3456/tutorials/pandas/6.html"
out = OUT / "qc-pandas-L6.png"
...
with sync_playwright() as p:
    ...
    try:
        ...
        page.route("**/cdn.plot.ly/**", lambda r: r.abort())  # also skip plotly
        ...
        print(f"  OK title={title[:50]!r} h1={h1!r}")
