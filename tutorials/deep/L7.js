...
+ '<p class="l-text">Diyelim ki köpek ırklarını sınıflandırmak istiyorsun, elinde 5.000 fotoğraf var. <a href="/tutorials/deep/6">Ders 6</a>\'da gördüğün gibi modern bir CNN (ResNet50, 25M parametre) bu kadar veriyle sıfırdan eğitilirse: ya overfitting, ya yetersiz öğrenme. Kötü sonuç garantili.</p>'
...
+ '<p class="l-text">Suppose you want to classify dog breeds and you have 5,000 photos. As you saw in <a href="/tutorials/deep/6">Lesson 6</a>, if a modern CNN (ResNet50, 25M parameters) is trained from scratch with this much data: either overfitting or insufficient learning. A bad result is guaranteed.</p>'
