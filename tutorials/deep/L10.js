...
+ '<p class="l-text">GPT, LLaMA, Claude — hepsi bu modeli izler. Decoder-only Transformer (<a href="/tutorials/deep/9">Ders 9</a>) causal mask ile eğitilir; çıkarımda bir token üretip prompt\'a ekler, tekrar çağırır.</p>'
...
+ '<p class="l-text">GPT, LLaMA, Claude — all follow this model. A decoder-only Transformer (<a href="/tutorials/deep/9">Lesson 9</a>) is trained with a causal mask; at inference it produces a token, appends it to the prompt, and is called again.</p>'
