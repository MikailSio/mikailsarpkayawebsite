...
+ '<p class="l-text">MNIST için kurduğumuz basit ağı hatırla (<a href="/tutorials/deep/1">Ders 1</a>): 784→128→10. Toplam parametre: 784·128 + 128 + 128·10 + 10 = <strong>101.770 ağırlık</strong>. Daha büyük ağlarda milyonlar, milyarlar. Eğitmek için her ağırlığın <em>kayıp fonksiyonuna katkısının türevini</em> bilmemiz gerek.</p>'
...
+ '<p class="l-text">Üç düğümü geriye doğru zincirle: her ara bağlantının yerel türevini al, çarp, geç. <a href="/tutorials/calculus/4">Calculus L4</a>\'te zincir kuralının formal türevini gördük; burada yapacağımız tam olarak o, ama bilgisayar üzerinde sistematik biçimde.</p>'
...
+ '<p class="l-text">Recall the simple network we built for MNIST (<a href="/tutorials/deep/1">Lesson 1</a>): 784→128→10. Total parameters: 784·128 + 128 + 128·10 + 10 = <strong>101,770 weights</strong>. Larger networks have millions or billions. To train them, we need to know <em>the derivative of the loss function with respect to every single weight</em>.</p>'
...
+ '<p class="l-text">Chain three nodes backwards: take each intermediate connection\'s local derivative, multiply, move on. We saw the formal derivation of the chain rule in <a href="/tutorials/calculus/4">Calculus L4</a>; what we are doing here is exactly that, but systematically on a computer.</p>'
