...
const STABLE_PYODIDE_TRACKS = [
  '/tutorials/programming/python/',     '/tutorials/ai/numpy/',
  '/tutorials/ai/pandas/',     '/tutorials/ai/sql/',
  '/tutorials/ai/matplotlib/', '/tutorials/ai/sklearn/',
  '/tutorials/ai/ml/',  '/tutorials/ai/nlp/',
  '/tutorials/ai/rl/',         '/tutorials/ai/causal/',
  '/tutorials/ai/timeseries/', '/tutorials/security/fairness/',
  '/tutorials/ai/recsys/',     '/tutorials/ai/gnn/',
  '/tutorials/security/privacy/',    '/tutorials/security/crypto/',
  '/tutorials/math/linalg/',     '/tutorials/math/calculus/',
  '/tutorials/ai/probability/',
];
