...
<div class="calc-highlight">📘 <strong>Math foundation:</strong> see <a href="/tutorials/deep/6">Deep Learning Lesson 6 — CNN Fundamentals</a> for the full convolution mechanics (filter sliding, stride/padding derivations, channel arithmetic). Here we focus on how the canonical block applies to vision tasks.</div>
...
<div class="calc-highlight">📘 <strong>Deeper coverage:</strong> <a href="/tutorials/deep/6">Deep Learning Lesson 6, section 10</a> derives receptive field math for general architectures. Here we focus on what it means for vision: object scale must fit inside the receptive field for the network to recognize it.</div>
...
<div class="calc-highlight">📘 <strong>Matematiksel temel:</strong> Konvolüsyonun tüm mekaniği (filtre kayması, stride/padding türetimi, kanal aritmetiği) için <a href="/tutorials/deep/6">Derin Öğrenme Dersi 6 — CNN Temelleri</a>'ne bakın. Burada bu temelin görüntü görevlerine nasıl uygulandığına odaklanıyoruz.</div>
...
<div class="calc-highlight">📘 <strong>Daha derin kapsam:</strong> <a href="/tutorials/deep/6">Derin Öğrenme Dersi 6, bölüm 10</a> alıcı alan matematiğini genel mimariler için türetir. Burada görüntü için ne anlama geldiğine odaklanıyoruz: nesne ölçeği ağın tanıyabilmesi için alıcı alan içine sığmalı.</div>
