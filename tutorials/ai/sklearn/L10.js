...
<p class="l-text">A one-paragraph refresher. Naive Bayes computes <em>P(class | features) ∝ P(class) · ∏ P(featureᵢ | class)</em> under the assumption that features are conditionally independent given the class. Despite this assumption being mostly false in practice, the algorithm dominates text classification because high-dimensional bag-of-words features behave just well enough for the independence to be a useful approximation. For full theory see <a href="/tutorials/ai/ml/naive-bayes">ML Theory Lesson 13</a>.</p>
