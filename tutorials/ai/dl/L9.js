...
+ '<p class="l-text"><a href="/tutorials/ai/dl/rnn-lstm-sequential">Ders 8</a>\'de RNN/LSTM\'i gördük. İki temel kısıtı var:</p>'
...
+ '<div class="calc-highlight">📘 <strong>Teori evi:</strong> <a href="/tutorials/ai/nlp/transformers-bert">NLP Dersi 10 — Transformer & BERT</a> attention mekanizmasını NLP bağlamında ilk prensiplerden türetir. Bu ders deep learning perspektifinden mimari görünümü verir.</div>'
...
+ '<p class="l-text">In <a href="/tutorials/ai/dl/rnn-lstm-sequential">Lesson 8</a> we saw RNN/LSTM. They have two core limitations:</p>'
...
+ '<div class="calc-highlight">📘 <strong>The home of the theory:</strong> <a href="/tutorials/ai/nlp/transformers-bert">NLP Lesson 10 — Transformer & BERT</a> derives the attention mechanism from first principles in the NLP context. This lesson gives the architectural view from the deep learning perspective.</div>'
