...
+ '<p class="l-text"><a href="/tutorials/ai/ml/linear-regression">ML L2</a> ve <a href="/tutorials/ai/ml/evaluation-hyperparameter-tuning">ML L5</a>\'te overfitting\'in ne olduğunu gördük: model eğitim verisinin gürültüsünü ezberler, görmediği veride başarısız olur. Derin ağlarda bu sorun çok daha keskin — milyonlarca parametre, hafıza kapasitesi sınırsız gibi.</p>'
...
+ '<p class="l-text">PyTorch\'ta optimizer parametresi olarak: <code>AdamW(model.parameters(), lr=3e-4, weight_decay=0.01)</code>. <a href="/tutorials/ai/dl/optimization-training-dynamics">Ders 4</a>\'te neden AdamW\'nin bunu doğru yaptığını gördük.</p>'
...
+ '<p class="l-text">In PyTorch as an optimizer parameter: <code>AdamW(model.parameters(), lr=3e-4, weight_decay=0.01)</code>. In <a href="/tutorials/ai/dl/optimization-training-dynamics">Lesson 4</a> we saw why AdamW does this correctly.</p>'
