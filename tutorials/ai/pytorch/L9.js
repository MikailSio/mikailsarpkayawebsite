...
<div class="calc-highlight">📘 <strong>Theory home:</strong> <a href="/tutorials/ai/nlp/transformers-bert">NLP Lesson 10 — Transformer &amp; BERT</a> derives the attention mechanism from first principles in NLP context (where it was invented). This lesson focuses on the PyTorch implementation: tensor shapes, einsum, and <code>nn.functional.scaled_dot_product_attention</code>.</div>
...
<div class="calc-highlight">📘 <strong>Teori evi:</strong> <a href="/tutorials/ai/nlp/transformers-bert">NLP Dersi 10 — Transformer &amp; BERT</a> attention mekanizmasını NLP bağlamında (icat edildiği yerde) ilk prensiplerden türetir. Bu ders PyTorch uygulamasına odaklanır: tensör şekilleri, einsum ve <code>nn.functional.scaled_dot_product_attention</code>.</div>
