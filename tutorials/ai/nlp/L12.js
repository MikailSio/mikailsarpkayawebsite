...
+ '<ul class="l-list">'
+ '<li>Veri toplama ve temizleme (<a href="/tutorials/ai/nlp/text-preprocessing">Ders 1</a>)</li>'
+ '<li>Vektörleştirme veya tokenizasyon (<a href="/tutorials/ai/nlp/bow-tfidf-ngrams">Ders 2</a>, <a href="/tutorials/ai/nlp/word-embeddings">Ders 5</a>)</li>'
...
+ '<li><strong>FastText alt-kelime embedding\'leri (<a href="/tutorials/ai/nlp/word-embeddings">Ders 5</a>):</strong> OOV problemini doğal yakalar.</li>'
+ '</ul>'
...
+ '<li><strong>Problem çerçeveleme (1-2 hafta):</strong> Görev tipi nedir (sınıflandırma <a href="/tutorials/ai/nlp/text-classification">L3</a>, sentiment <a href="/tutorials/ai/nlp/sentiment-analysis">L4</a>, NER <a href="/tutorials/ai/nlp/sequence-labeling">L7</a>, üretim <a href="/tutorials/ai/nlp/seq2seq-attention">L9</a>+<a href="/tutorials/ai/nlp/generative-llms">L11</a>)? Tek paragraflık problem ifadesi + 3 spesifik araştırma sorusu.</li>'
+ '<li><strong>Veri (2-4 hafta):</strong> Veri seti tanımla veya topla. Kaynağını belgele. Ön işleme (<a href="/tutorials/ai/nlp/text-preprocessing">L1</a>). Sınıf dengesi, uzunluk dağılımı, kelime dağarcığı istatistikleri. Train/val/test böl, sızıntı olmadan.</li>'
+ '<li><strong>Baseline (4-6 hafta):</strong> (a) Çoğunluk sınıfı baseline. (b) TF-IDF + lojistik regresyon (<a href="/tutorials/ai/nlp/bow-tfidf-ngrams">L2</a>+<a href="/tutorials/ai/nlp/text-classification">L3</a>). (c) BERTurk fine-tune (<a href="/tutorials/ai/nlp/transformers-bert">L10</a>). (d) Llama zero-shot (<a href="/tutorials/ai/nlp/generative-llms">L11</a>). Hepsini çalıştır. Sonuçlar genelde proje planını yeniden şekillendirir.</li>'
...
+ '<ul class="l-list">'
+ '<li>Data collection and cleaning (<a href="/tutorials/ai/nlp/text-preprocessing">Lesson 1</a>)</li>'
+ '<li>Vectorisation or tokenisation (<a href="/tutorials/ai/nlp/bow-tfidf-ngrams">Lesson 2</a>, <a href="/tutorials/ai/nlp/word-embeddings">Lesson 5</a>)</li>'
...
+ '<li><strong>FastText subword embeddings (<a href="/tutorials/ai/nlp/word-embeddings">Lesson 5</a>):</strong> handle OOV naturally.</li>'
+ '</ul>'
...
+ '<ol class="l-list" style="font-size:.95rem">'
+ '<li><strong>Problem framing (week 1-2):</strong> What task type (classification <a href="/tutorials/ai/nlp/text-classification">L3</a>, sentiment <a href="/tutorials/ai/nlp/sentiment-analysis">L4</a>, NER <a href="/tutorials/ai/nlp/sequence-labeling">L7</a>, generation <a href="/tutorials/ai/nlp/seq2seq-attention">L9</a>+<a href="/tutorials/ai/nlp/generative-llms">L11</a>)? One-paragraph problem statement + 3 specific research questions.</li>'
+ '<li><strong>Data (week 2-4):</strong> Define or collect a dataset. Document its source. Preprocess (<a href="/tutorials/ai/nlp/text-preprocessing">L1</a>). Class balance, length distribution, vocabulary stats. Train/val/test split, no leakage.</li>'
+ '<li><strong>Baselines (week 4-6):</strong> (a) majority class baseline. (b) TF-IDF + LR (<a href="/tutorials/ai/nlp/bow-tfidf-ngrams">L2</a>+<a href="/tutorials/ai/nlp/text-classification">L3</a>). (c) BERTurk fine-tune (<a href="/tutorials/ai/nlp/transformers-bert">L10</a>). (d) Llama zero-shot (<a href="/tutorials/ai/nlp/generative-llms">L11</a>). Run them all. Surprises here usually reshape your plan.</li>'
...
+ '<p class="l-text">You finished the twelve-lesson NLP course. From regex and stemming in <a href="/tutorials/ai/nlp/text-preprocessing">Lesson 1</a> to production RAG systems, agents, and a complete end-to-end project template in <a href="/tutorials/ai/nlp/applied-nlp">Lesson 12</a>, you now hold an end-to-end mental model of modern natural language processing — the same model a working practitioner uses to read papers, debug pipelines, and design experiments. Take a breath. This is a real milestone.</p>'
