...
+ '<p class="l-text"><a href="/tutorials/ai/nlp/seq2seq-attention">Ders 9</a>\'da RNN tabanlı seq2seq + attention\'ı gördük. RNN\'lerin iki büyük problemi vardı:</p>'
...
+ '<p class="l-text"><a href="/tutorials/ai/nlp/seq2seq-attention">Ders 9</a>\'da attention encoder ile decoder arasındaydı (cross-attention). <strong>Self-attention</strong> aynı mantığı tek bir cümlenin <em>kendi kelimeleri arasında</em> uygular: her kelime, aynı cümledeki diğer kelimelere bakar.</p>'
...
+ '<p class="l-text"><strong>GPT (Generative Pre-trained Transformer)</strong>, OpenAI\'nın 2018 yayını, BERT\'in zıttı: sadece decoder kısmı, sadece sola bakar. Eğitim hedefi <strong>bir sonraki kelimeyi tahmin etmek</strong> — klasik dil modelleme görevi (<a href="/tutorials/ai/nlp/language-models">Ders 8</a>).</p>'
...
+ '<p class="l-text">In <a href="/tutorials/ai/nlp/seq2seq-attention">Lesson 9</a> we saw RNN-based seq2seq + attention. RNNs had two big problems:</p>'
...
+ '<p class="l-text">In <a href="/tutorials/ai/nlp/seq2seq-attention">Lesson 9</a> attention was between encoder and decoder (cross-attention). <strong>Self-attention</strong> applies the same idea <em>within a single sentence</em>: each word attends to other words in the same sentence.</p>'
...
+ '<p class="l-text"><strong>GPT (Generative Pre-trained Transformer)</strong>, OpenAI 2018, is the opposite of BERT: only the decoder, only looks left. The training objective is <strong>predict the next word</strong> — the classical language modelling task (<a href="/tutorials/ai/nlp/language-models">Lesson 8</a>).</p>'
