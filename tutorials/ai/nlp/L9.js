...
+ '<div class="calc-highlight"><strong>Bu derste ne öğreneceksin:</strong> Şimdiye kadar her görev tek-yönlü idi: girdi → tek etiket veya tek-cümle çıktı. Bu derste <strong>diziden diziye (sequence-to-sequence)</strong> görevleri öğreniyoruz: girdi bir cümle, çıktı da bir cümle. Makine çevirisi, özetleme, soru-cevap. Encoder-decoder mimarisini, neden saf RNN\'in uzun cümlelerde tıkandığını ve bunu çözen <strong>attention (dikkat)</strong> mekanizmasını adım adım göreceksin. Attention, Transformer\'ın temel taşıdır — bu ders <a href="/tutorials/ai/nlp/transformers-bert">Ders 10</a>\'a doğrudan köprü kurar.</div>'
...
+ '<li><strong>Multi-head attention:</strong> Aynı işi paralel birden fazla "kafa" ile yap. Her kafa farklı ilişkiler yakalar. Transformer\'ın merkezindedir, <a href="/tutorials/ai/nlp/transformers-bert">Ders 10</a>\'da detayında.</li>'
+ '</ul>'
...
+ '<li><strong>Multi-head attention:</strong> run several attention "heads" in parallel; each captures a different relation. The core of the Transformer, detailed in <a href="/tutorials/ai/nlp/transformers-bert">Lesson 10</a>.</li>'
+ '</ul>'
...
+ '<p class="l-text">In this lesson you learned seq2seq tasks, the encoder-decoder architecture, the information bottleneck of vanilla RNNs, and how attention solves it. Attention alone is the foundation of the Transformer. <a href="/tutorials/ai/nlp/transformers-bert">Lesson 10</a> covers Vaswani et al.\'s "Attention is All You Need" — replacing RNNs entirely with attention, how multi-head self-attention works, and why parallelism made the Transformer revolutionary for NLP. BERT and GPT are built on this architecture.</p>'
