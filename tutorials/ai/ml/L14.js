...
+ '<p class="l-text">Yani kNN <em>kavram olarak</em> 70 yaşında ama <em>uygulama olarak</em> hiç olmadığı kadar yaygın. Modern NLP/ML\'de "embedding üret + ANN ara" şeklinde her yerde. <a href="/tutorials/ai/langchain/">LangChain</a>, <a href="/tutorials/ai/huggingface/">HuggingFace</a> ve <a href="/tutorials/ai/nlp/">NLP</a> derslerinde bu pratikte göreceksin.</p>'

+ '<h2 class="l-title">11. Bir Sonraki Adım</h2>'

+ '<p class="l-text">Dört temel klasik sınıflandırıcıyı (lojistik regresyon, SVM, Naive Bayes, kNN) artık biliyorsun. Sıradaki kavramlar: <a href="/tutorials/ai/ml/generalization-bias-variance">genelleme ve cross-validation</a>, <a href="/tutorials/ai/ml/trees-ensembles-xgboost">karar ağaçları</a> ve sonra <a href="/tutorials/ai/ml/clustering">ensemble (random forest, gradient boosting)</a>. Bu yapı taşları birleştiğinde gerçek dünya tabular problemlerinin %80\'ini çözen modeller elde edersin.</p>'
...
+ '<p class="l-text">So kNN is 70 years old <em>conceptually</em>, but as <em>deployment</em> it is more widespread than ever. The modern NLP/ML pattern is "produce an embedding + do ANN search" everywhere. You will see this in practice in our <a href="/tutorials/ai/langchain/">LangChain</a>, <a href="/tutorials/ai/huggingface/">HuggingFace</a>, and <a href="/tutorials/ai/nlp/">NLP</a> tracks.</p>'

+ '<h2 class="l-title">11. What\'s Next</h2>'

+ '<p class="l-text">You now know the four classical classifiers: logistic regression, SVM, Naive Bayes, kNN. Up next: <a href="/tutorials/ai/ml/generalization-bias-variance">generalisation and cross-validation</a>, <a href="/tutorials/ai/ml/trees-ensembles-xgboost">decision trees</a>, then <a href="/tutorials/ai/ml/clustering">ensembles (random forest, gradient boosting)</a>. Combine these building blocks and you can solve roughly 80% of real-world tabular problems.</p>'
