...
+ '<p class="l-text"><a href="/tutorials/ai/ml/logistic-regression-classification">L3</a>\'te lojistik regresyonu kullandık ama "C parametresi nedir?" sorusunu erteledik. Cevap:</p>'
...
+ '<p class="l-text">Lineer modellerin overfitting\'le mücadelesini öğrendik. Şimdi tamamen farklı bir aileye geçiyoruz: <a href="/tutorials/ai/ml/trees-ensembles-xgboost">Ders 7</a> — <strong>Karar Ağaçları ve Ensemble Yöntemleri</strong>. Tek bir ağaç, Random Forest, Gradient Boosting, XGBoost. Tablo verisinde sıkça en iyi sonucu veren bu yöntemleri öğreneceksin.</p>'
...
+ '<p class="l-text">In <a href="/tutorials/ai/ml/logistic-regression-classification">L3</a> we used logistic regression but deferred "what is the C parameter?". Answer:</p>'
...
+ '<p class="l-text">We learned linear models\' fight against overfitting. Now to a completely different family: <a href="/tutorials/ai/ml/trees-ensembles-xgboost">Lesson 7</a> — <strong>decision trees and ensembles</strong>. Single trees, Random Forest, Gradient Boosting, XGBoost. The methods that often win on tabular data.</p>'
