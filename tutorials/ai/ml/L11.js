...
+ '<p class="l-text"><strong>SHAP (SHapley Additive exPlanations)</strong> oyun teorisi temelli, her tahmin için her özelliğin katkısını hesaplar. <a href="/tutorials/ai/ml/trees-ensembles-xgboost">L7</a>\'de bahsettik; pratik:</p>'
...
+ '<li><strong>Derin Öğrenme:</strong> Sinir ağları, CNN\'ler, RNN\'ler için <a href="/tutorials/ai/dl/">DL kursumuza</a> geç.</li>'
+ '<li><strong>NLP:</strong> Metin işleme, transformer\'lar, LLM\'ler için <a href="/tutorials/ai/nlp/">NLP kursumuza</a> bak.</li>'
...
+ '<p class="l-text"><strong>SHAP (SHapley Additive exPlanations)</strong> uses game theory to compute each feature\'s contribution per prediction. Mentioned in <a href="/tutorials/ai/ml/trees-ensembles-xgboost">L7</a>; in practice:</p>'
...
+ '<li><strong>Deep Learning:</strong> neural nets, CNNs, RNNs — see our <a href="/tutorials/ai/dl/">DL course</a>.</li>'
+ '<li><strong>NLP:</strong> text processing, transformers, LLMs — see our <a href="/tutorials/ai/nlp/">NLP course</a>.</li>'
