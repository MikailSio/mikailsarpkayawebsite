...
+ '<p class="l-text">Lojistik regresyon (<a href="/tutorials/ai/ml/logistic-regression-classification">L3</a>) bir olasılık döner. Hangi olasılığın üstündekini "kayıp" sayacağız? Varsayılan 0.5; ama bu ayarlanabilir bir <strong>eşik</strong>tir.</p>'
...
+ '<li><strong>R² (<a href="/tutorials/ai/ml/linear-regression">L2</a>):</strong> açıklanan varyans oranı.</li>'
+ '</ul>'
...
+ '<p class="l-text">Modeli ölçmeyi öğrendik. Şimdi modelin <em>kendisini iyileştirme</em> yöntemlerine geçiyoruz. <a href="/tutorials/ai/ml/regularization">Ders 6</a>: <strong>Regularization</strong>. Modeli aşırı öğrenmeden korumak için L1/L2 cezaları, Ridge, Lasso, ElasticNet, dropout. Lineer regresyon ve lojistik regresyondaki "C" hyperparametresinin ne kontrol ettiğini öğreneceksin.</p>'
...
+ '<p class="l-text">Logistic regression (<a href="/tutorials/ai/ml/logistic-regression-classification">L3</a>) outputs a probability. Above what probability do we say "churn"? The default 0.5 is just a tunable <strong>threshold</strong>.</p>'
...
+ '<li><strong>R² (<a href="/tutorials/ai/ml/linear-regression">L2</a>):</strong> fraction of variance explained.</li>'
+ '</ul>'
...
+ '<p class="l-text">We learned to measure models. Now we move to <em>improving them</em>. <a href="/tutorials/ai/ml/regularization">Lesson 6</a>: <strong>Regularisation</strong>. L1/L2 penalties, Ridge, Lasso, ElasticNet, dropout — keeping models from overfitting. You will learn what the "C" hyperparameter in linear/logistic regression really controls.</p>'
