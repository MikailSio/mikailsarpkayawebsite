...
+ '<p class="l-text">Yani Naive Bayes <em>tarihi bir merak</em> değil — günümüzde aktif kullanılan, anlamak zorunda olduğun temel bir araç. <a href="/tutorials/ai/sklearn/naive-bayes">sklearn Ders 10</a>\'da hepsini sklearn API\'siyle uygulayacaksın.</p>'

+ '<h2 class="l-title">11. Sonraki Adım</h2>'

+ '<p class="l-text">Sınıflandırma alet kutumuza üçüncü algoritmayı (Naive Bayes) ekledik. Şimdiye kadar gördüklerimiz: lineer/lojistik regresyon (Ders 2-3), Naive Bayes (bu ders), kısmen kNN. <a href="/tutorials/ai/ml/generalization-bias-variance">Ders 4</a>\'te genelleme ve cross-validation\'a bakacağız — bu algoritmaları hangisinin <em>gerçekten</em> daha iyi olduğunu nasıl ölçeceğiz?</p>'
...
+ '<p class="l-text">So Naive Bayes is not a historical curiosity — it is an actively used tool you must understand. In <a href="/tutorials/ai/sklearn/naive-bayes">sklearn Lesson 10</a> you will apply all of this with the sklearn API.</p>'

+ '<h2 class="l-title">11. Next Step</h2>'

+ '<p class="l-text">We have added a third algorithm (Naive Bayes) to our classification toolkit. So far: linear/logistic regression (Lessons 2-3), Naive Bayes (this lesson), and a glimpse of kNN. <a href="/tutorials/ai/ml/generalization-bias-variance">Lesson 4</a> tackles generalisation and cross-validation — how do we measure which of these algorithms is <em>actually</em> better?</p>'
