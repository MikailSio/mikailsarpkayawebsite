...
+ '<p class="l-text">C\'nin doğru değeri verilerin gürültü seviyesine ve örtüşmesine bağlıdır — <a href="/tutorials/ai/ml/generalization-bias-variance">Ders 4</a>\'teki cross-validation ile bulunur. Pratik tavsiye: log-uzayda <em>C ∈ {0.01, 0.1, 1, 10, 100}</em> ızgarası ile başla.</p>'
...
+ '<p class="l-text">The right C depends on noise level and class overlap — find it via cross-validation (<a href="/tutorials/ai/ml/generalization-bias-variance">Lesson 4</a>). Practical recipe: start with a log-spaced grid <em>C ∈ {0.01, 0.1, 1, 10, 100}</em>.</p>'
