...
<p class="l-text">If any of the words "margin", "support vector", "kernel trick", "C parameter" feel hand-wavy, read <a href="/tutorials/ml-theory/12">ML Theory Lesson 12</a> first; the derivations sit there. This lesson assumes you know what those words mean and shows you how to turn them into running code.</p>
...
<p class="l-text">You now have a complete SVM workflow. Combined with the theory in <a href="/tutorials/ml-theory/12">ML Theory Lesson 12</a>, you can both reason about why an SVM works and ship one tomorrow. Next stop in the sklearn track: ensemble methods or model deployment, depending on which gap you want to close first.</p>
</div>
...
tr: `<p class="l-text"><strong>Support Vector Machine\'ler yüksek boyutlu, orta büyüklükte, iyi koşullanmış verinin klasik ML çekicidir.</strong> 2012 öncesi dönemin krallarıydılar ve hâlâ masada yerlerini hak ediyorlar: ciddi bir NLP araştırmacısı yeni bir probleme önce TF-IDF + LinearSVC ile vurur, transformer\'a sonra geçer; iyi mühendislenmiş 1000 öznitelik üstünde RBF SVM, ayar yapılmış bir random forest\'ı rahatlıkla yakalar. Bu ders <a href="/tutorials/ml-theory/12">ML Teori Ders 12</a>\'deki teorinin pratik kardeşi — aynı fikirler, ama bu sefer gerçekten ürün edeceğin sklearn API\'si üstünden.</p>
...
<p class="l-text">"Marj", "destek vektörü", "çekirdek hilesi", "C parametresi" kelimeleri havada kalıyorsa önce <a href="/tutorials/ml-theory/12">ML Teori Ders 12</a>\'yi oku — türetmeler orada. Bu ders o kelimelerin anlamını bildiğini varsayar ve onları nasıl çalışan koda dökeceğini gösterir.</p>
