...
+ '<p class="l-text">Denetimli öğrenmenin en güçlü ailesini öğrendik. Şimdi tamamen farklı bir alana — etiket olmadan veriden bilgi çıkarmaya — geçiyoruz. <a href="/tutorials/ml-theory/8">Ders 8</a>: <strong>Denetimsiz öğrenme — Clustering</strong>. k-Means, DBSCAN, hierarchical, müşteri segmentasyonu. Etiketsiz müşteri verisinde "doğal grupları" otomatik keşfetme.</p>'
...
+ '<p class="l-text">We have learned the strongest family of supervised learning. Now to a different territory — extracting structure from data without labels. <a href="/tutorials/ml-theory/8">Lesson 8</a>: <strong>unsupervised learning — clustering</strong>. k-Means, DBSCAN, hierarchical, customer segmentation. Discovering "natural groups" in unlabelled customer data.</p>'
