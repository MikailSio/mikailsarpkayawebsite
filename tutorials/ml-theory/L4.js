...
+ '<p class="l-text">We answered "how do we know a model is good?". But "good" is not a single number. <a href="/tutorials/ml-theory/5">Lesson 5</a> dives into <strong>evaluation metrics</strong> — accuracy, precision, recall, F1, ROC-AUC, confusion matrix. Which metric for which task? Plus <strong>hyperparameter tuning</strong>: GridSearchCV, Optuna, finding the best model systematically.</p>'
