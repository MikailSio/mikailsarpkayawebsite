...
+ '<li><strong>Boyut indirgeme (<a href="/tutorials/ml-theory/9">L9</a>):</strong> "Hangi özellikler birlikte hareket ediyor?" Görselleştirme, sıkıştırma.</li>'
+ '</ul>'
...
+ '<p class="l-text">Kümeleme ile veri içindeki yapıyı keşfettik. Ama 20 boyutlu veride kümeleme görselleştirmek zor. <a href="/tutorials/ml-theory/9">Ders 9</a>: <strong>Boyut indirgeme</strong>. PCA, t-SNE, UMAP ile yüksek boyutlu veriyi 2-3 boyuta düşürüp görselleştirme. Plus: özellik mühendisliği için boyut indirgeme.</p>'
...
+ '<li><strong>Dimensionality reduction (<a href="/tutorials/ml-theory/9">L9</a>):</strong> "Which features move together?" Visualisation, compression.</li>'
+ '</ul>'
