...
+ '<p class="l-text">Müşteri kayıp problemini tanıdık, ML\'in temel kavramlarını gördük. Şimdi gerçek bir ML algoritmasıyla başlayalım: <a href="/tutorials/ml-theory/2">Ders 2 — Lineer Regresyon</a>. Müşterinin gelecek 12 ayda ne kadar ödeyeceğini tahmin edeceğiz. Bu, en basit ama en temel öğrenme algoritmasıdır; gradyan iniş, MSE kaybı, polinom genişletme gibi her ML algoritmasında karşımıza çıkacak fikirleri öğreneceğiz.</p>'
...
+ '<p class="l-text">We have introduced the customer churn problem and the basics of ML. Now let us tackle a real ML algorithm: <a href="/tutorials/ml-theory/2">Lesson 2 — Linear Regression</a>. We will predict how much a customer is expected to spend over the next 12 months. It is the simplest yet most fundamental learning algorithm; we will meet ideas (gradient descent, MSE loss, polynomial expansion) that show up in every ML algorithm.</p>'
