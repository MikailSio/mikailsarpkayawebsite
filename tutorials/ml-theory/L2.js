...
+ '<p class="l-text">Vektör notasyonuyla matematiğin tamamı tek bir formüle indirgenir. Bu yüzden lineer cebir ML\'in temelidir (<a href="/tutorials/linalg/">Doğrusal Cebir kursu</a>).</p>'
...
+ '</ul>'
+ '<p class="l-text" style="margin-top:.4rem">Bu denge sorununa <strong>bias-variance trade-off</strong> denir; <a href="/tutorials/ml-theory/4">Ders 4</a>\'te derinlemesine işleyeceğiz.</p>'
+ '</div></div>'
...
+ '<p class="l-text">Lineer regresyon ile sayısal hedef tahminini öğrendik. Müşteri kayıp problemine geri döndüğümüzde aslında bize lazım olan farklı: "bu müşteri kayıp mı?" — sayı değil, evet/hayır cevabı. Bu sınıflandırma görevidir. <a href="/tutorials/ml-theory/3">Ders 3</a>\'te <strong>Lojistik Regresyon</strong> ile bunu çözmeye geçeceğiz. Lineer regresyonun kuzeni gibi düşünebilirsin — aynı doğrusal kombinasyon, ama çıktıyı 0-1 arası bir olasılığa sıkıştırıyor.</p>'
...
+ '<p class="l-text"><strong>Regression</strong> is supervised learning where the target is a <em>continuous number</em>. From the customer churn data of <a href="/tutorials/ml-theory/1">Lesson 1</a> consider a sub-problem: "How much will this customer pay over the next 12 months?" The answer is a continuous number like $1,240 or $980 or $2,150. This differs from classification — classification produces discrete labels (yes/no); regression produces a numeric prediction.</p>'
...
+ '<p class="l-text">In vector notation everything reduces to a single formula. This is why linear algebra is the foundation of ML (<a href="/tutorials/linalg/">Linear Algebra course</a>).</p>'
...
+ '</ul>'
+ '<p class="l-text" style="margin-top:.4rem">This trade-off is called <strong>bias-variance trade-off</strong> — covered deeply in <a href="/tutorials/ml-theory/4">Lesson 4</a>.</p>'
+ '</div></div>'
