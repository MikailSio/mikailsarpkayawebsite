...
+ '</p>'
+ '<p class="l-text">Üç yorum, iki olumlu (1, 3) bir olumsuz (2). <a href="/tutorials/nlp/1">Ders 1</a>\'deki ön işlemeyi uyguladıktan sonra elimizde şu token listeleri var:</p>'
+ '<p class="l-text" style="font-family:var(--mono);font-size:.95rem;line-height:1.9">'
...
+ '</p>'
+ '<p class="l-text">Three reviews, two positive (1, 3) and one negative (2). After applying the preprocessing from <a href="/tutorials/nlp/1">Lesson 1</a>, we have these token lists:</p>'
+ '<p class="l-text" style="font-family:var(--mono);font-size:.95rem;line-height:1.9">'
...
+ '<p class="l-text">You can now turn the clean tokens from <a href="/tutorials/nlp/1">Lesson 1</a> into numerical vectors. Each of the three reviews in our mini corpus is now a vector — with TF-IDF scores. In <a href="/tutorials/nlp/3">Lesson 3</a> we plug those vectors into a real machine learning model: <strong>Naive Bayes</strong> and <strong>logistic regression</strong> to predict whether a movie review is positive or negative. The classical golden age of NLP starts here.</p>'
