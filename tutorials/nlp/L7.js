...
+ '<li><strong>Aspect Extraction (yön çıkarımı):</strong> ürün yorumunda hangi özellik bahsedildiğini bulma — <a href="/tutorials/nlp/4">Ders 4</a>\'te değindik.</li>'
+ '</ul>'
...
+ '<p class="l-text">2018\'den sonra <strong>BERT</strong> (<a href="/tutorials/nlp/10">Ders 10</a>) NER\'in altın standardı oldu. Mantık:</p>'
...
+ '<p class="l-text">Türkçede özel isimler büyük harfle başlar — değerli sinyal. Eğer ön işlemede her şeyi küçük harfe çevirirsen NER doğruluğu düşer. <strong>NER için lowercase yapma</strong> (<a href="/tutorials/nlp/1">Ders 1</a>\'deki tablo).</p>'
...
+ '<p class="l-text">Token bazlı sınıflandırmayı (denetimli) öğrendin. Şu ana kadar gördüğümüz tüm yöntemler "metni anla" odaklıydı. <a href="/tutorials/nlp/8">Ders 8</a>\'de farklı bir görev türüne geçiyoruz: <strong>dil modelleme (language modeling)</strong>. Verili bir bağlamda bir sonraki kelimenin ne olacağını tahmin etme. Bu, GPT\'nin temel görevidir — modern büyük dil modellerinin (LLM) kalbi.</p>'
...
+ '<li><strong>Aspect Extraction:</strong> identifying which feature is mentioned in a product review — touched on in <a href="/tutorials/nlp/4">Lesson 4</a>.</li>'
+ '</ul>'
...
+ '<p class="l-text">After 2018 <strong>BERT</strong> (<a href="/tutorials/nlp/10">Lesson 10</a>) became the gold standard for NER:</p>'
...
+ '<p class="l-text">Turkish proper nouns start with a capital — a valuable signal. Lowercasing during preprocessing kills NER accuracy. <strong>Do not lowercase for NER</strong> (see the table in <a href="/tutorials/nlp/1">Lesson 1</a>).</p>'
...
+ '<p class="l-text">You have learned token-level supervised classification. So far every method we have seen has been "understand the text". <a href="/tutorials/nlp/8">Lesson 8</a> moves to a different kind of task: <strong>language modelling</strong>. Predicting the next word given context. This is GPT\'s core task — the heart of modern large language models.</p>'
