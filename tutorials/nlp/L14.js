...
+ '<p class="l-text"><a href="/tutorials/nlp/11">Ders 11</a>\'de gördüğümüz klasik LLM\'ler tek bir <em>otoregresif</em> akış üretir: token token cevap yazar, üretmediği bir şeyi düşünemez. Aritmetik veya çok adımlı mantık gerektiren bir soruda, kâğıt kalem kullanmadan zihinden cevap vermeye çalışan bir öğrenci gibidir.</p>'
...
+ '<p class="l-text"><a href="/tutorials/nlp/11">Ders 11</a>\'de Chinchilla ölçek yasasını gördük: <em>daha çok parametre + daha çok veri = daha iyi model</em>. Bu yasa <strong>eğitim zamanı</strong> ölçeklemesidir.</p>'
...
+ '<p class="l-text"><a href="/tutorials/nlp/11">Ders 11</a>\'de gördüğümüz <strong>RLHF</strong> şöyle çalışıyordu:</p>'
...
+ '<p class="l-text">En önemli 2026 trendi: <strong>düşünme + araç kullanımı entegrasyonu</strong>. Klasik ReAct (<a href="/tutorials/nlp/12">Ders 12</a>) ajan ile basit LLM\'i sarmalardı. Modern akıl yürüten modeller <em>düşünme zincirinin içinde</em> doğal olarak araç çağırabilir:</p>'
...
+ '<li><a href="/tutorials/nlp/12">Ders 12</a>\'deki RAG ve ajan kalıbını şimdi akıl yürüten bir LLM ile kur. Aradaki farkı kendin hisset.</li>'
+ '</ul>'
...
+ '<p class="l-text">In <a href="/tutorials/nlp/11">Lesson 11</a> we covered the Chinchilla scaling law: <em>more parameters + more data = better model</em>. That law governs <strong>train-time scaling</strong>.</p>'
...
+ '<p class="l-text">Recall RLHF from <a href="/tutorials/nlp/11">Lesson 11</a>:</p>'
...
+ '<p class="l-text">The most important 2026 trend: <strong>integrated thinking + tool use</strong>. Classical ReAct agents (<a href="/tutorials/nlp/12">Lesson 12</a>) wrapped a plain LLM. Modern reasoning models can call tools <em>inside</em> their chain-of-thought:</p>'
...
+ '<li>Rebuild the RAG + agent pattern from <a href="/tutorials/nlp/12">Lesson 12</a> using a reasoning LLM. Feel the difference firsthand.</li>'
+ '</ul>'
